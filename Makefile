...
prod: docker-down-clear docker-pull docker-build docker-up manager-init manager-assets-install manager-assets-prod perm
test: manager-test
...
manager-assets-prod:
	docker-compose run --rm manager-node npm run build
