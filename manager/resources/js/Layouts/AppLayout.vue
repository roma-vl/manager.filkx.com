    ...
    <div class="grid grid-rows-[auto_1fr] grid-cols-[auto_1fr] h-screen font-sans bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
        ...
        >
            ...
            <nav class="p-4 space-y-2">
                ...
                <NavItem v-if="canManageUsers" icon="folder" to="/users" :active="$page.url.startsWith('/users')">
                    Users
                </NavItem>
                ...
                <NavItem icon="users" to="/team" :active="$page.url.startsWith('/team')">
                    Team
                </NavItem>
        ...
        <!-- Header -->
        <header class="bg-white dark:bg-gray-800 shadow-sm z-10 col-start-2 row-start-1">
            <div class="flex items-center justify-between h-16 px-6">
                <div class="flex items-center">
                    <button @click="toggleSidebar" class="text-gray-500 dark:text-gray-300 mr-4 focus:outline-none lg:hidden">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-6 w-6"
                            fill="none"
                    ...
                    <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ $page.props.title || 'Dashboard' }}</h2>
                </div>

                <div class="flex items-center space-x-4">
                    <button class="p-1 text-gray-400 hover:text-gray-500 dark:hover:text-white focus:outline-none">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-6 w-6"
                            fill="none"
        ...
        <!-- Main Content -->
        <main class="col-start-2 row-start-2 overflow-y-auto p-6 bg-gray-50 dark:bg-gray-900">
            <Transition name="fade" mode="out-in">
                <div class="max-w-7xl mx-auto">
                    <div v-if="showFlash && flash.error" class="mb-4 p-3 bg-red-100 dark:bg-red-800 text-red-700 dark:text-red-200 rounded">
                        {{ flash.error }}
                    </div>
