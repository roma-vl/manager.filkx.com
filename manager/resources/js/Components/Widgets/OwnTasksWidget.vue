...
<template>
    <div class="dark:bg-[#0e0f11] bg-gradient-to-br from-gray-900 to-indigo-900 text-white  mt-6 rounded-2xl shadow-md transition-all duration-300 ease-in-outmx-auto p-2">
        <div class="px-2 py-2 border-b dark:border-gray-700 flex items-center justify-between">
            ...
            <a href="/work/projects/tasks/own" class="text-sm text-gray-500 dark:text-gray-400 hover:underline">
                View All
            </a>
        </div>
