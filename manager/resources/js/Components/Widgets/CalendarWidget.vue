...
<template>
    <div    class="dark:bg-[#0e0f11] bg-gradient-to-br from-gray-900 to-indigo-900 text-white  mt-6 rounded-2xl shadow-md transition-all duration-300 ease-in-out max-w-7xl mx-auto"
    >
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full table-fixed text-sm text-gray-700 dark:text-gray-300 border-collapse">
                <thead>
                <tr>
                    <th
                        v-for="date in dates"
                ...
                <tr>
                    ...
                    >
                        <div class="space-y-2">
                            ...
                            >
                                <div v-if="iconsForItem(item, date).length" class="border border-gray-300 dark:border-gray-700 rounded-lg p-2 bg-gray-50 dark:bg-gray-800 shadow-sm hover:shadow-md transition">
