    ...
    <AppLayout>
        ...
        <nav class="text-sm text-muted-foreground mb-6" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2">
                ...
                <li><Link href="/work/projects/roles" class="hover:text-primary">Roles</Link><span>/</span></li>
        ...
        <div class="flex gap-3 mb-4">
            <Link
                :href="`/work/projects/roles/${role.id}/edit`"
            ...
            <Link
                :href="`/work/projects/roles/${role.id}/copy`"
                class="btn btn-primary"
            >
                Copy
            </Link>
        ...
        <div class="box bg-white dark:bg-gray-900 rounded-xl shadow p-6">
            <table class="table-auto w-full border-collapse border border-gray-200 dark:border-gray-700">
                ...
                <tr class="border-b border-gray-200 dark:border-gray-700">
                    <th class="text-left py-2 px-4 font-semibold text-gray-700 dark:text-gray-300 w-32">Name</th>
                    <td class="py-2 px-4 text-gray-900 dark:text-gray-100">{{ role.name }}</td>
                </tr>
                <tr>
                    <th class="text-left py-2 px-4 font-semibold text-gray-700 dark:text-gray-300 align-top">Permissions</th>
