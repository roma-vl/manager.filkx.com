    ...
    <AppLayout>
        ...
        <nav class="text-sm text-muted-foreground mb-6" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2">
                ...
                <li><Link :href="`/work/projects/${project.id}`" class="hover:text-primary">{{ project.name }}</Link><span>/</span></li>
                <li><Link :href="`/work/projects/${project.id}/settings`" class="hover:text-primary">Settings</Link><span>/</span></li>
                <li><Link :href="`/work/projects/${project.id}/settings/departments`" class="hover:text-primary">Departments</Link><span>/</span></li>
