    ...
    <AppLayout>
        ...
        <nav class="text-sm text-muted-foreground mb-6" aria-label="Breadcrumb">
            <ol class="flex flex-wrap items-center gap-1 text-gray-500">
                ...
                <li><Link href="/work/projects" class="hover:text-gray-700 transition">Projects</Link><span>/</span></li>
                <li><Link :href="`/work/projects/${project.id}`" class="hover:text-gray-700 transition">{{ project.name }}</Link><span>/</span></li>
                <li><Link :href="`/work/projects/${project.id}/settings`" class="hover:text-gray-700 transition">Settings</Link><span>/</span></li>
        ...
        <div class="overflow-x-auto bg-white shadow-sm rounded-xl border">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tr v-for="department in departments" :key="department.id" class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{ department.members_count }}</td>
