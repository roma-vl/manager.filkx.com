...
function confirmAndRevoke(memberId) {
    ...
    axios.post(
        `/work/projects/${props.project.id}/settings/members/${memberId}/revoke`,
        { preserveScroll: true }
    )
}
</script>
    ...
    <AppLayout>
        ...
        <nav class="text-sm text-muted-foreground mb-6" aria-label="Breadcrumb">
            <ol class="flex flex-wrap items-center gap-1 text-gray-500">
                ...
                <li><Link href="/work/projects" class="hover:text-gray-700">Projects</Link><span>/</span></li>
                <li><Link :href="`/work/projects/${props.project.id}`" class="hover:text-gray-700">{{ props.project.name }}</Link><span>/</span></li>
                <li><Link :href="`/work/projects/${props.project.id}/settings`" class="hover:text-gray-700">Settings</Link><span>/</span></li>
        ...
        <div class="flex gap-2 mb-4">
            <Link :href="`/work/projects/${props.project.id}/settings/members/assign`" class="btn btn-success">Assign Member</Link>
...
<!--                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path d="M12.293 2.293a1 1 0 011.414 0L18 6.586a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0L7 13.414a1 1 0 010-1.414l8-8z"/></svg>-->
<!--                        </a>-->
<!--                    </td>-->
<!--                    <td class="px-4 py-2">-->
...
<!--                                ✏️-->
<!--                            </Link>-->
<!--                            <button @click="confirmAndRevoke(membership.member.id)" class="btn btn-sm btn-danger">-->
<!--                                ❌-->
<!--                            </button>-->
<!--                        </div>-->
<!--                    </td>-->
