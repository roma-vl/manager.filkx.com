...
import {formatStatus, formatType, statusBadgeClass, typeBadgeClass} from "../../../../../Helpers/tasks.helper.js";
...
<template>
    <div class="relative inline-block text-left">
        <button
            ...
            :class="['px-2 py-1 rounded text-xs font-semibold flex items-center gap-1', typeBadgeClass(selectedType)]"
        >
