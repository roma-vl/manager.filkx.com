<template>
    <AppLayout>
        ...
        <!-- Table -->
        <div class="overflow-x-auto rounded-xl shadow-md bg-gray-900/80 backdrop-blur border border-gray-700 text-white">
            <table class="min-w-full divide-y divide-gray-800">
                <thead class="bg-gray-800 text-left text-xs font-semibold text-white/70">
                <tr>
                    <th @click="toggleSort('name')" class="th-sort">Name <span v-if="sort === 'name'">{{ directionIcon }}</span></th>
                    <th @click="toggleSort('email')" class="th-sort">Email <span v-if="sort === 'email'">{{ directionIcon }}</span></th>
