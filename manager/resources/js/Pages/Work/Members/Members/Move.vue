    ...
    <AppLayout>
        ...
        <nav class="text-sm text-gray-500 mb-4" aria-label="Breadcrumb">
            <ol class="flex space-x-2">
                ...
                <li><Link href="/work/members" class="hover:text-blue-600">Members</Link><span class="mx-2">/</span></li>
                <li><Link :href="`/work/members/${member.id}`" class="hover:text-blue-600">{{ member.name }}</Link><span class="mx-2">/</span></li>
