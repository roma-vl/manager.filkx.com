    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-100">
        <div class="max-w-md w-full bg-white p-8 rounded shadow">
            ...
            <div class="mt-6 space-y-2">
                <a href="/oauth/facebook" class="block text-center py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
                    Login with Facebook
                </a>
                <a href="/oauth/google" class="block text-center py-2 bg-red-600 text-white rounded hover:bg-red-700">
                    Login with Google
                </a>
            </div>
        </div>
