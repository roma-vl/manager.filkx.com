...
<template>
    <AppLayout title="Users">
        <div class="space-y-4">
            ...
            <!-- Filters -->
            <form @submit.prevent="submitFilters" class="grid grid-cols-1 md:grid-cols-5 gap-4 bg-white p-4 shadow rounded">
            ...
            <div class="overflow-auto rounded shadow">
                <table class="table-auto w-full">
                    ...
                    <tr v-for="user in users" :key="user.id" class="hover:bg-gray-50">
                        ...
                        <td class="p-2">
                            <Link :href="`/users/${user.id}`" class="text-blue-600 hover:underline">{{ user.name }}</Link>
                        </td>
            ...
            <!-- Pagination -->
            <div v-if="props.pagination.lastPage > 1" class="mt-4 flex justify-center space-x-1 items-center">
                <span
